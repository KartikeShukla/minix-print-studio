...
def test_source_package_check_requires_packaged_app_smoke_validator() -> None:
    validator = _load_validator()

    assert Path("scripts/validate_packaged_app_smoke.py") in validator.REQUIRED_SOURCE_PATHS
