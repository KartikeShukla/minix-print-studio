...
1. Complete project management coverage: renderer daemon client methods and Projects UI that replaces single-document localStorage as the primary saved-project path.
