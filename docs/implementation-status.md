...
- Playwright MCP smoke against `http://127.0.0.1:5173/`: renderer loads after Projects/image-asset import changes, the Image import button and Projects panel render, and the browser console only shows the React DevTools hint.
...
1. Complete project management coverage: migrate away from single-document localStorage as the primary saved-project path.
