...
| Windows | Unsigned package evidence captured | Release Package workflow run `27053365446` completed `pnpm package:win` on a Windows runner with bundled daemon/MCP sidecars; installer packaging and signing are pending. |
